define(["exports", "fable-core", "virtual-dom"], function (exports, _fableCore, _virtualDom) {
    ...
    var createTree = exports.createTree = function (tag, attributes, children) {
        ...
        }, hAttrs = toAttrs(attributes), childrenArr = Array.from(children), function () {
            return function () {
                var clo1;
                return clo1 = _fableCore.String.fsFormat("This is sparta: %A")(function (x) {
                    console.log(x);
                }), function (arg10) {
                    clo1(arg10);
                };
            }();
        }()(hAttrs), (0, _virtualDom.h)(tag, hAttrs, childrenArr);
    };
...
//# sourceMappingURL=Fable.Helpers.Virtualdom-1906846644.js.map