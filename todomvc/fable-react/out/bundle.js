...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.render = exports.model = exports.TodoApp = exports.TodoAppState = exports.TodoAppProps = exports.TodoFooter = exports.TodoItem = exports.COMPLETED_TODOS = exports.ACTIVE_TODOS = exports.ALL_TODOS = exports.ENTER_KEY = exports.ESCAPE_KEY = exports.TodoItemState = exports.TodoModel = exports.Util = exports.Todo = exports.Req = undefined;
	...
	var $import5 = _interopRequireWildcard(_react);
	...
	var Req = exports.Req = function ($exports) {
	    var classNames = $exports.classNames = __webpack_require__(170);
	
	    var Router = $exports.Router = __webpack_require__(171).Router;
	...
	var Todo = exports.Todo = function Todo($arg0, $arg1, $arg2) {
	...
	_fableCore.Util.setInterfaces(Todo.prototype, [], "React-todomvc.Todo");
	...
	var Util = exports.Util = function () {
	    ...
	    _createClass(Util, null, [{
	        ...
	        value: function uuid() {
	            var makeRandom;
	            return makeRandom = function () {
	                var rnd;
	                return rnd = {}, function (unitVar0) {
	                    return Math.floor(Math.random() * (16 - 0)) + 0;
	                };
	            }(), _fableCore.Seq.fold(function (uuid, i) {
	                return function () {
	                    var hyphen, random, $target0;
	                    return hyphen = ($target0 = function () {
	                        return "-";
	                    }, i === 8 ? $target0() : i === 12 ? $target0() : i === 16 ? $target0() : i === 20 ? $target0() : ""), random = i === 12 ? 4 : i === 16 ? makeRandom() & 3 | 8 : makeRandom(), function () {
	                        return function () {
	                            var clo1;
	                            return clo1 = _fableCore.String.fsFormat("%s%s%s")(function (x) {
	                                return x;
	                            }), function (arg10) {
	                                return function () {
	                                    var clo2;
	                    ...
	                    }()(uuid)(hyphen)(random.toString(16));
	                }();
	            }, "", _fableCore.Seq.range(0, 31));
	        }
	    }, {
	        key: "pluralize",
	        ...
	        key: "store",
	        value: function store(ns) {
	            var matchValue, data;
	            return matchValue = localStorage.getItem(ns), matchValue == null ? [] : (data = matchValue, JSON.parse(data));
	        }
	    }, {
	        key: "store_1",
	        value: function store_1(ns, data) {
	...
	_fableCore.Util.setInterfaces(Util.prototype, [], "React-todomvc.Util");
	...
	var TodoModel = exports.TodoModel = function () {
	    ...
	    _createClass(TodoModel, [{
	        ...
	        value: function inform() {
	            Util.store_1(this.key, this.todos);
	
	            _fableCore.Seq.iter(function (cb) {
	                cb();
	            }, this.onChanges);
	        }
	    }, {
	        ...
	        value: function addTodo(title) {
	            ...
	            this.todos = Array.from(_fableCore.Seq.delay(function (unitVar) {
	                return _fableCore.Seq.append(_this.todos, _fableCore.Seq.delay(function (unitVar_1) {
	                    return _fableCore.Seq.singleton(new Todo(Util.uuid(), title, false));
	                }));
	            }));
	            this.inform();
	        }
	        ...
	        value: function toggleAll(checked_) {
	            this.todos = Array.from(_fableCore.Seq.map(function (todo) {
	        ...
	        value: function toggle(todoToToggle) {
	            this.todos = Array.from(_fableCore.Seq.map(function (todo) {
	                var completed;
	                return todo.id !== todoToToggle.id ? todo : (completed = !todo.completed, new Todo(todo.id, todo.title, completed));
	            }, this.todos));
	            this.inform();
	        }
	    }, {
	        ...
	        value: function destroy(todo) {
	            this.todos = this.todos.filter(function (y) {
	                return _fableCore.Util.compareTo(todo, y) !== 0;
	            });
	            this.inform();
	        }
	    }, {
	...
	var TodoItemState = exports.TodoItemState = function TodoItemState($arg0) {
	    _classCallCheck(this, TodoItemState);
	
	    this.editText = $arg0;
	};
	
	_fableCore.Util.setInterfaces(TodoItemState.prototype, [], "React-todomvc.TodoItemState");
	...
	var TodoItem = exports.TodoItem = function (_$import) {
	    _inherits(TodoItem, _$import);
	
	    function TodoItem(props) {
	        _classCallCheck(this, TodoItem);
	
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoItem).call(this, props, new TodoItemState(props.todo.title)));
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function handleSubmit(e) {
	            var value;
	            var matchValue = this.state.editText.trim();
	            (value = matchValue, value.length > 0) ? (value = matchValue, this.props.onSave(value), this.setState(new TodoItemState(value))) : this.props.onDestroy(e);
	        }
	    }, {
	        key: "handleEdit",
	        ...
	        value: function handleKeyDown(e) {
	            ...
	            matchValue === 27 ? (this.setState(new TodoItemState(this.props.todo.title)), this.props.onCancel(e)) : matchValue === 13 ? this.handleSubmit(e) : null;
	        }
	    }, {
	        key: "handleChange",
	        value: function handleChange(e) {
	            this.props.editing ? this.setState(new TodoItemState(e.target.value.toString())) : null;
	        }
	    }, {
	        key: "shouldComponentUpdate",
	        value: function shouldComponentUpdate(nextProps, nextState) {
	            return (_fableCore.Util.compareTo(nextProps.todo, this.props.todo) !== 0 ? true : nextProps.editing !== this.props.editing) ? true : nextState.editText !== this.state.editText;
	        }
	    }, {
	        key: "componentDidUpdate",
	        value: function componentDidUpdate(prevProps) {
	            var node;
	            (!prevProps.editing ? this.props.editing : false) ? (node = $import4.findDOMNode(this.editField), node.focus(), node.setSelectionRange(node.value.length, node.value.length)) : null;
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            return className = Req.classNames({
	                completed: this.props.todo.completed,
	                editing: this.props.editing
	            }), $import5.createElement.apply($import5, ["li", {
	                className: className
	            }].concat([$import5.createElement.apply($import5, ["div", {
	                className: "view"
	            }].concat([$import5.createElement.apply($import5, ["input", {
	                className: "toggle",
	                type: "checkbox",
	                checked: this.props.todo.completed,
	                onChange: function () {
	                    var objectArg;
	                    return objectArg = _this3.props, function (arg00) {
	                        objectArg.onToggle(arg00);
	                    };
	                }()
	            }].concat([])), $import5.createElement.apply($import5, ["label", {
	                onDoubleClick: function (arg00) {
	                    _this3.handleEdit(arg00);
	                }
	            }].concat([this.props.todo.title])), $import5.createElement.apply($import5, ["button", {
	                className: "destroy",
	                onClick: function () {
	                    var objectArg;
	                    return objectArg = _this3.props, function (arg00) {
	                ...
	                onBlur: function (arg00) {
	                    _this3.handleSubmit(arg00);
	                },
	                onChange: function (arg00) {
	                    _this3.handleChange(arg00);
	                },
	                onKeyDown: function (arg00) {
	...
	var TodoFooter = exports.TodoFooter = function (_$import2) {
	    _inherits(TodoFooter, _$import2);
	
	    function TodoFooter(props) {
	        _classCallCheck(this, TodoFooter);
	
	        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoFooter).call(this, props));
	    ...
	    _createClass(TodoFooter, [{
	        ...
	        value: function render() {
	            ...
	            return activeTodoWord = function (arg00) {
	                return function (arg10) {
	                    return Util.pluralize(arg00, arg10);
	                };
	            }(this.props.count)("item"), clearButton = this.props.completedCount > 0 ? function (arg0) {
	                return arg0;
	            }($import5.createElement.apply($import5, ["button", {
	                className: "clear-completed",
	                onClick: function () {
	                    var objectArg;
	                    return objectArg = _this5.props, function (arg00) {
	                        objectArg.onClearCompleted(arg00);
	                    };
	                }()
	            }].concat(["Clear completed"]))) : null, className = function (category) {
	                return Req.classNames({
	                    selected: _this5.props.nowShowing === category
	                });
	            }, $import5.createElement.apply($import5, ["footer", {
	                className: "footer"
	            }].concat([$import5.createElement.apply($import5, ["span", {
	                className: "todo-count"
	            }].concat([$import5.createElement.apply($import5, ["strong", {}].concat([this.props.count])), " " + activeTodoWord + " left"])), $import5.createElement.apply($import5, ["ul", {
	                className: "filters"
	            }].concat([$import5.createElement.apply($import5, ["li", {}].concat([$import5.createElement.apply($import5, ["a", {
	                href: "#/",
	                className: className("all")
	            }].concat(["All"]))])), " ", $import5.createElement.apply($import5, ["li", {}].concat([$import5.createElement.apply($import5, ["a", {
	                href: "#/active",
	                className: className("active")
	            }].concat(["Active"]))])), " ", $import5.createElement.apply($import5, ["li", {}].concat([$import5.createElement.apply($import5, ["a", {
	                href: "#/completed",
	...
	var TodoAppProps = exports.TodoAppProps = function TodoAppProps($arg0) {
	    _classCallCheck(this, TodoAppProps);
	
	    this.model = $arg0;
	};
	
	_fableCore.Util.setInterfaces(TodoAppProps.prototype, [], "React-todomvc.TodoAppProps");
	
	var TodoAppState = exports.TodoAppState = function TodoAppState($arg0, $arg1, $arg2) {
	    _classCallCheck(this, TodoAppState);
	
	    this.nowShowing = $arg0;
	    this.editing = $arg1;
	    this.newTodo = $arg2;
	};
	
	_fableCore.Util.setInterfaces(TodoAppState.prototype, [], "React-todomvc.TodoAppState");
	
	var TodoApp = exports.TodoApp = function (_$import3) {
	    _inherits(TodoApp, _$import3);
	
	    function TodoApp(props) {
	        _classCallCheck(this, TodoApp);
	
	        var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoApp).call(this, props, new TodoAppState("all", null, "")));
	    ...
	    _createClass(TodoApp, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            return nowShowing = function (category) {
	                return function (unitVar0) {
	                    var inputRecord;
	
	                    _this7.setState((inputRecord = _this7.state, new TodoAppState(category, inputRecord.editing, inputRecord.newTodo)));
	                };
	            }, router = Req.Router({
	                "/": nowShowing("all"),
	        ...
	        value: function handleChange(ev) {
	            var inputRecord, newTodo;
	            this.setState((inputRecord = this.state, newTodo = ev.target.value, new TodoAppState(inputRecord.nowShowing, inputRecord.editing, newTodo)));
	        }
	    }, {
	        key: "handleNewTodoKeyDown",
	        value: function handleNewTodoKeyDown(ev) {
	            var v, inputRecord, newTodo;
	            ev.keyCode === 13 ? (ev.preventDefault(), v = this.state.newTodo.trim(), v.length > 0 ? (this.props.model.addTodo(v), this.setState((inputRecord = this.state, newTodo = "", new TodoAppState(inputRecord.nowShowing, inputRecord.editing, newTodo)))) : null) : null;
	        }
	    }, {
	        key: "toggleAll",
	        ...
	        value: function edit(todo) {
	            var inputRecord, editing;
	            this.setState((inputRecord = this.state, editing = todo.id, new TodoAppState(inputRecord.nowShowing, editing, inputRecord.newTodo)));
	        }
	    }, {
	        key: "save",
	        value: function save(todoToSave, text) {
	            ...
	            this.setState((inputRecord = this.state, editing = null, new TodoAppState(inputRecord.nowShowing, editing, inputRecord.newTodo)));
	        }
	    }, {
	        key: "cancel",
	        ...
	        value: function render() {
	            ...
	            return todos = this.props.model.todos, todoItems = Array.from(_fableCore.Seq.map(function (todo) {
	                var $var5, _Object$definePropert;
	
	                return $import5.createElement.apply($import5, [TodoItem, (0, _FableHelpers.toPlainJsObj)(($var5 = _this8, Object.defineProperties((_Object$definePropert = {}, _defineProperty(_Object$definePropert, _fableCore.Symbol.interfaces, ["React-todomvc.TodoItemProps"]), _defineProperty(_Object$definePropert, "onToggle", function (_arg1) {
	                    $var5.toggle(todo);
	                }), _defineProperty(_Object$definePropert, "onDestroy", function (_arg2) {
	                    $var5.destroy(todo);
	                }), _defineProperty(_Object$definePropert, "onEdit", function (_arg3) {
	                    $var5.edit(todo);
	                }), _defineProperty(_Object$definePropert, "onSave", function (text) {
	                    $var5.save(todo, text.toString());
	                }), _defineProperty(_Object$definePropert, "onCancel", function (_arg4) {
	                    $var5.cancel();
	                    ...
	                    editing: {
	                        get: function () {
	                            var matchValue, editing;
	                            return matchValue = $var5.state.editing, matchValue == null ? false : (editing = matchValue, editing === todo.id);
	                        },
	                        configurable: true,
	                        enumerable: true
	                    }
	                ...
	                var matchValue;
	                return matchValue = _this8.state.nowShowing, matchValue === "active" ? !todo.completed : matchValue === "completed" ? todo.completed : true;
	            }))), activeTodoCount = _fableCore.Seq.fold(function (accum, todo) {
	                return todo.completed ? accum : accum + 1;
	            }, 0, todos), completedCount = todos.length - activeTodoCount, footer = (activeTodoCount > 0 ? true : completedCount > 0) ? function (arg0) {
	                return arg0;
	            }($import5.createElement.apply($import5, [TodoFooter, (0, _FableHelpers.toPlainJsObj)(($var6 = this, Object.defineProperties((_Object$definePropert2 = {}, _defineProperty(_Object$definePropert2, _fableCore.Symbol.interfaces, ["React-todomvc.TodoFooterProps"]), _defineProperty(_Object$definePropert2, "onClearCompleted", function (_arg5) {
	                $var6.clearCompleted();
	            }), _Object$definePropert2), {
	                count: {
	                    get: function () {
	                ...
	                nowShowing: {
	                    get: function () {
	                        return $var6.state.nowShowing;
	                    },
	                    configurable: true,
	                    enumerable: true
	                }
	            })))].concat([]))) : null, main = todos.length > 0 ? function (arg0) {
	                return arg0;
	            }($import5.createElement.apply($import5, ["section", {
	                className: "main"
	            }].concat([$import5.createElement.apply($import5, ["input", {
	                className: "toggle-all",
	                type: "checkbox",
	                onChange: function (arg00) {
	                    _this8.toggleAll(arg00);
	                },
	                checked: activeTodoCount === 0
	            }].concat([])), $import5.createElement.apply($import5, ["ul", {
	                className: "todo-list"
	            }].concat([todoItems]))]))) : null, $import5.createElement.apply($import5, ["div", {}].concat([$import5.createElement.apply($import5, ["header", {
	                className: "header"
	            }].concat([$import5.createElement.apply($import5, ["h1", {}].concat(["todos"])), $import5.createElement.apply($import5, ["input", {
	                className: "new-todo",
	                placeholder: "What needs to be done?",
	                value: this.state.newTodo,
	                onKeyDown: function (arg00) {
	                    _this8.handleNewTodoKeyDown(arg00);
	                },
	                onChange: function (arg00) {
	                    _this8.handleChange(arg00);
	                },
	                autoFocus: true
	            }].concat([]))])), main, footer]));
	        }
	...
	var render = exports.render = function () {
	    $import4.render($import5.createElement.apply($import5, [TodoApp, (0, _FableHelpers.toPlainJsObj)(new TodoAppProps(model))].concat([])), document.getElementsByClassName("todoapp")[0]);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toPlainJsObj = exports.toPlainJsObj = function (source) {
	    var transferValueOrGetter, source_1, target, matchValue, proto;
	    return transferValueOrGetter = function (source_1) {
	        return function (thisValue) {
	            return function (target) {
	                return function (k) {
	                    var prop, matchValue, getter, value;
	                    return prop = Object.getOwnPropertyDescriptor(source_1, k), (matchValue = [prop.value, prop.get], matchValue[0] == null ? matchValue[1] != null ? (getter = matchValue[1], target[k] = getter.apply(thisValue)) : null : (value = matchValue[0], target[k] = value)), target;
	                };
	            };
	        };
	    }, source == null ? null : (source_1 = source, target = _fableCore.Seq.fold(function ($var1, $var2) {
	        return transferValueOrGetter(source_1)(source_1)($var1)($var2);
	    }, {}, Object.getOwnPropertyNames(source_1)), matchValue = Object.getPrototypeOf(source_1), (proto = matchValue, proto != null ? proto === Object : false) ? (proto = matchValue, _fableCore.Seq.fold(function ($var3, $var4) {
	        return transferValueOrGetter(proto)(source_1)($var3)($var4);
	    }, target, Object.getOwnPropertyNames(proto))) : target);
	};
